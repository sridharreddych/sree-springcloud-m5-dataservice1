...
import sree.demo.SreeSpringcloudM5Dataservice3Application;

@SpringBootApplication
@RestController
public class SreeSpringcloudM5Dataservice3Application {

	public static void main(String[] args) {
		SpringApplication.run(SreeSpringcloudM5Dataservice3Application.class, args);
	}
